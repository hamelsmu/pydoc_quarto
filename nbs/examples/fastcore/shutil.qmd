...
```{=html}
<blockquote><strong><code>copytree(src, dst, symlinks=False, ignore=None, copy_function=<function copy2 at 0x10b921430>, ignore_dangling_symlinks=False, dirs_exist_ok=False)</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>move(src, dst, copy_function=<function copy2 at 0x10b921430>)</code></strong></blockquote>
```
