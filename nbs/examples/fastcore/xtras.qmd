...
```
     ...
     |  ReindexCollection(coll, idxs=None, cache=None, tfm=<function noop at 0x10bb5bee0>)
     |  
...
#### `ReindexCollection.__init__`
     |  
     |  __init__(self, coll, idxs=None, cache=None, tfm=<function noop at 0x10bb5bee0>)
     |      Initialize self.  See help(type(self)) for accurate signature.
     |  
     |  
...
```{=html}
<blockquote><strong><code>globtastic(path: 'Path | str', recursive: 'bool' = True, symlinks: 'bool' = True, file_glob: 'str' = None, file_re: 'str' = None, folder_re: 'str' = None, skip_file_glob: 'str' = None, skip_file_re: 'str' = None, skip_folder_re: 'str' = None, func: 'callable' = <function join at 0x10b547940>, ret_folders: 'bool' = False) -> 'L'</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>walk(path: 'Path | str', symlinks: 'bool' = True, keep_file: 'callable' = <function ret_true at 0x10bb95700>, keep_folder: 'callable' = <function ret_true at 0x10bb95700>, skip_folder: 'callable' = <function ret_false at 0x10bb95790>, func: 'callable' = <function join at 0x10b547940>, ret_folders: 'bool' = False)</code></strong></blockquote>
```
