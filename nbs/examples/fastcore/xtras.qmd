...
<strong>class ReindexCollection(fastcore.basics.GetAttr, IterLen)</strong>
     ...
     |  ReindexCollection(coll, idxs=None, cache=None, tfm=<function noop at 0x100d15480>)
     |  
...
#### ReindexCollection.__init__
     |  
     |  __init__(self, coll, idxs=None, cache=None, tfm=<function noop at 0x100d15480>)
     |      Initialize self.  See help(type(self)) for accurate signature.
     |  
     |  
...
<strong>globtastic(path: 'Path | str', recursive: 'bool' = True, symlinks: 'bool' = True, file_glob: 'str' = None, file_re: 'str' = None, folder_re: 'str' = None, skip_file_glob: 'str' = None, skip_file_re: 'str' = None, skip_folder_re: 'str' = None, func: 'callable' = <function join at 0x100646b90>, ret_folders: 'bool' = False) -> 'L'</strong>
...
<strong>walk(path: 'Path | str', symlinks: 'bool' = True, keep_file: 'callable' = <function ret_true at 0x100d748b0>, keep_folder: 'callable' = <function ret_true at 0x100d748b0>, skip_folder: 'callable' = <function ret_false at 0x100d74940>, func: 'callable' = <function join at 0x100646b90>, ret_folders: 'bool' = False)</strong>
