...
#### `L.filter`
     |  
     |  filter(self, f=<function noop at 0x10bb5bee0>, negate=False, gen=False, **kwargs)
...
#### `L.map_dict`
     |  
     |  map_dict(self, f=<function noop at 0x10bb5bee0>, *args, gen=False, **kwargs)
     |      Like `map`, but creates a dict from `items` to function results
     |  
     |  
#### `L.map_first`
     |  
     |  map_first(self, f=<function noop at 0x10bb5bee0>, g=<function noop at 0x10bb5bee0>, *args, **kwargs)
