...
```{=html}
<blockquote><strong><code>class NullType(builtins.object)</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>add(a, b=<object object at 0x103405140>)</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>eq(a, b=<object object at 0x103405140>)</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>filter_ex(iterable, f=<function noop at 0x103bc1480>, negate=False, gen=False, **kwargs)</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>ge(a, b=<object object at 0x103405140>)</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>gen(func, seq, cond=<function ret_true at 0x103c148b0>)</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>groupby(x, key, val=<function noop at 0x103bc1480>)</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>gt(a, b=<object object at 0x103405140>)</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>in_(a, b=<object object at 0x103405140>)</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>is_(a, b=<object object at 0x103405140>)</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>is_not(a, b=<object object at 0x103405140>)</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>le(a, b=<object object at 0x103405140>)</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>lt(a, b=<object object at 0x103405140>)</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>maps(*args, retain=<function noop at 0x103bc1480>)</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>mul(a, b=<object object at 0x103405140>)</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>ne(a, b=<object object at 0x103405140>)</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>sub(a, b=<object object at 0x103405140>)</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>tonull(x)</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>truediv(a, b=<object object at 0x103405140>)</code></strong></blockquote>
```
