---
title: "adapters"
description: "module requests.adapters in requests"
---
...
```{=html}
<blockquote><strong><code>class BaseAdapter(builtins.object)</code></strong></blockquote>
```
...
```{=html}
<blockquote><strong><code>class HTTPAdapter(BaseAdapter)</code></strong></blockquote>
```
